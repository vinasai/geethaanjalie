               ...
               <div className="row">
                  ...
                  <div className="col-xxl-5 col-xl-5 col-lg-5">
                     <div className="about__content pl-70 pr-25">
                        ...
                        <p>Our mission is to inspire, educate, and empower students to connect with the essence of Carnatic music, embracing both its technical brilliance and emotional depth. We focus on vocal training, instrumental proficiency, theory, and improvisation, ensuring a comprehensive learning experience.</p>
