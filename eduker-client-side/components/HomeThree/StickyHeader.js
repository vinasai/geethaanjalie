...
const StickyHeader = () => {
   ...
   return (
      <>
         <section id="header-sticky" className={headerSticky ? "mobile__menu header__area header__sticky" :
            "mobile__menu header__area"}>
                  ...
                  <div className="row align-items-center">
                     <div className="col-xxl-8 col-xl-9 col-lg-10 col-md-6 col-6">
                        <div className="header__bottom-left d-flex align-items-center">
                           <div className="logo">
                              <Link href="/">
                                 <a >
                                    <img src="assets/img/logo/logo.png" alt="logo" style={{ height: "50px", width: "50px" }}/>
                                 </a>
                              </Link>
                           </div>
                           <div className="main-menu main-menu-2 main-menu-mobile ml-30 pl-30 d-none d-lg-block">
                              <nav id="mobile-menu ">
                                 <ul>
                                    {!user?.email &&
                                       links.map((link) => {
                     ...
                     <div className="col-xxl-4 col-xl-3 col-lg-2 col-md-6 col-6">
                        <div className="header__bottom-right d-flex justify-content-end align-items-center pl-30">
                           ...
                           <div className="header__search header__search-2 header__search-3 d-none d-xl-block">
                              <form action="#">
                           ...
                           <div className="header__hamburger ml-50 d-xl-none">
                              <button type="button" className="hamurger-btn" onClick={handleShow}>
                                 <span></span>
                                 <span></span>
                                 <span></span>
                              </button>
