...
const DynamicEventArea = ({ eventDetails }) => {
   // distructure eventDetails
   const { event_img, tutor_img, tutor_name, review, price, time, end_time, title, date } = eventDetails || {}
   return (
      <>
         <section className="event__area pt-115 p-relative">
            <div className="page__title-shape">
               <img className="page-title-shape-5 d-none d-sm-block"
                  src={"/assets/img/breadcrumb/page-title-shape-1.png"} alt="" />
...
export default DynamicEventArea;